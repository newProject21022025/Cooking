...
export default function CreateDishForm({ initialData, onSubmit }: CreateDishFormProps) {
  ...
  const mapIngredientWithCategory = (ing: any, defaultCategory: string) => {
  ...
  const handleSubmit = async (values: FormValues) => {
    try {
      ...
      console.error("Помилка створення страви:", err.response?.data || err.message);
