...
// ✅ ІМПОРТУЄМО ToggleFavoriteButton
...
export default function DishCard({ dish }: DishCardProps) {
  ...
  const router = useRouter(); // ✅ Ініціалізація перекладу
  const t = useTranslations("DishCard");
  const [showIngredients, setShowIngredients] = useState(false); // ... (Функції navigateToDishPage та handleCookClick без змін) ...
