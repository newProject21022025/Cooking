    ...
    <div className={styles.privacyPage}>
      <div className={styles.container}>
        ...
        <p className={styles.introduction}>
          MealUp поважає вашу конфіденційність і прагне захищати ваші
          персональні дані. Ця політика конфіденційності пояснює, які дані ми
          збираємо, як їх використовуємо і зберігаємо, а також ваші права у
          зв&apos;язку з цим.
        </p>
        ...
        <section className={styles.section}>
          ...
          <p className={styles.sectionText}>Ми можемо збирати такі дані:</p>
          <p className={styles.sectionText}>
            Персональні дані, які ви надаєте під час реєстрації або замовлення:
            ім&apos;я, електронна адреса, телефон, адреса доставки.
          </p>
          <p className={styles.sectionText}>
            Інформація про використання сайту: переглянуті сторінки, обраний
            товар, історія замовлень.
          </p>
          <p className={styles.sectionText}>
            Технічні дані: IP-адреса, тип браузера, налаштування пристрою.
          </p>
          <p className={styles.sectionText}>
            Файли cookie для покращення користувацького досвіду та
        ...
        <section className={styles.section}>
          ...
          <p className={styles.sectionText}>Ваші дані використовуються для:</p>
          <p className={styles.sectionText}>
            Обробки замовлень і доставки страв.
          </p>
          <p className={styles.sectionText}>
            Надсилання підтверджень, оновлень замовлень та сервісних
            повідомлень.
          </p>
          <p className={styles.sectionText}>
        ...
        <section className={styles.section}>
          ...
          <p className={styles.sectionText}>
            Постачальникам послуг: доставці, обробки платежів для виконання
            замовлень.
          </p>
          <p className={styles.sectionText}>
        ...
        <section className={styles.section}>
          ...
          <p className={styles.sectionText}>
            ...
            для надання послуг або дотримання законодавства. Після цього дані
            анонімізуються або видаляються.
          </p>
        </section>
        ...
        <section className={styles.section}>
          ...
          <p className={styles.sectionText}>Ви маєте право:</p>
          <p className={styles.sectionText}>
          ...
          <p className={styles.sectionText}>
            Вимагати видалення персональних даних (за винятком випадків,
        ...
        <section className={styles.section}>
          ...
          <p className={styles.sectionText}>Персоналізації контенту.</p>
          <p className={styles.sectionText}>Аналітики та покращення сервісу.</p>
          <p className={styles.sectionText}>
            Ви можете налаштувати свій браузер для відмови від сookies, але
            деякі функції сайту можуть бути недоступні.
          </p>
        </section>
        ...
        <section className={styles.section}>
          ...
          <p className={styles.sectionText}>
            ...
            даних від несанкціонованого доступу, втрати або зміни.
          </p>
        </section>
        ...
        <section className={styles.section}>
          ...
          <p className={styles.sectionText}>
            Email:{" "}
            <a href="mailto:support@mealup.com" className={styles.emailLink}>
              support@mealup.com
            </a>
          </p>
        </section>
